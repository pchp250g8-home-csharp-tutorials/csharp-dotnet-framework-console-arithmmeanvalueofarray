...
.NetFrameWork platform. Simple input/output. Working with arrays and random numbers. Calculating the arithmetic mean of array elements.
...
Консольное приложение разработано в интегрированной среде Microsoft Visual Studio на языке прораммирования C# под платформу .NetFramework. 
